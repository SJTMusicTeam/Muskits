...
n_all=$(find muskit -name "*.py" | wc -l)
...
flake8 --show-source --extend-ignore=D test utils doc ${flake8_black_list} muskit test egs/*/*/local/*.py

# white list of files that should support flake8-docstrings
flake8 --show-source muskit --exclude=${flake8_black_list//$'\n'/,}
