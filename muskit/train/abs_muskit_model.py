...
class AbsMuskitModel(torch.nn.Module, ABC):
    ...
    Example:
        ...
        >>> class YourMuskitModel(AbsMuskitModel):
        ...     def forward(self, input, input_lengths):
        ...         ...
        ...         return loss, stats, weight
        >>> class YourTask(AbsTask):
        ...     @classmethod
        ...     def build_model(cls, args: argparse.Namespace) -> YourMuskitModel:
    """
